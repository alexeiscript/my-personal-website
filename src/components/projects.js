...
function Projects() {
    const myWorks = [
        {id: 1, title: 'Dostoyevsky Quotes', description: 'A quote generator built with JavaScript, which randomly iterates through an array of quotes', img: 'http://alexei.one/dostoyevsky-quotes/dstvsk.png', link: 'https://dostoyevsky-quotes.netlify.app/'},
        {id: 2, title: 'Matching Poster Game', description: 'A game built with JavaScript, involving DOM manipulation and conditionals', img: 'http://alexei.one/matching-game/matching-game.png', link: 'https://poster-match.netlify.app/'},
