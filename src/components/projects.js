...
function Projects() {
    const myWorks = [
        {id: 1, title: 'Dostoyevsky Quotes', description: 'A quote generator built with JavaScript, which randomly iterates through an array of quotes', img: 'https://ibb.co/9WZC3hs', link: 'https://dostoyevsky-quotes.netlify.app/'},
        {id: 2, title: 'Matching Poster Game', description: 'A game built with JavaScript, involving DOM manipulation and conditionals', img: 'https://ibb.co/CstfqkR', link: 'https://poster-match.netlify.app/'},
