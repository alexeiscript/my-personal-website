...
function Projects() {
    const myWorks = [
        ...
        {id: 3, title: 'Calculator', description: 'A basic working calculator built with React as part of an online JavaScript course', img: 'https://images.freeimages.com/images/large-previews/916/calculator-and-pen-indicating-work-study-1632106.jpg', link: 'https://ok-calculator.netlify.app/'},
